...
namespace Communication
{
    ...
    public class XgDataPicker
    {
        ...
        private DataField _devType = new DataField(
            XGDefinition.DEVICE_TYPE_POS,
            1,
            new byte[] { XGDefinition.DEVICE_TYPE }
            );

        private DataField _innerDataLen = new DataField(
            XGDefinition.INNER_DATA_LENGTH_POS,
            1,
            null 
            );

        private int _minLen = XGDefinition.ZERO_DATA_CMD_LENGTH;
