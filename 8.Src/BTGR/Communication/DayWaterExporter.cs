...
namespace Communication
{
    ...
    /// 
    /// </summary>
    public class DayWaterExporter
    {
        #region Members
        private DateTime _beginDate,
            _endDate;

        private ArrayList _wdpSet;
        ...
        public DayWaterExporter(DateTime beginDate, DateTime endDate, ArrayList wdpSet )
        {
