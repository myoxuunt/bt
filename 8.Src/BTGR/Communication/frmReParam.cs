...
namespace Communication
{
	...
	public class frmReParam : System.Windows.Forms.Form
	{
		...
		{
			get { return _mode;}
		} private RePumpMode _mode = RePumpMode.PID控制;
		...
		{
			this.comboBox1.Items.Add( RePumpMode.PID控制);
			this.comboBox1.Items.Add( RePumpMode.回水压力输出控制 );
			this.comboBox1.Items.Add( RePumpMode.电磁阀控制 );
