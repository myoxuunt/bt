...
class AssemblyRef
{
    ...
    //public const string BaseResourceName = "Infragistics.Shared.strings;Infragistics.Shared.strings.CalcEngine";
    public const string BaseResourceName = "CFW.strings";

    // AS 6/17/04 Moved from Binder.cs to make it easier to manage.
    //internal const string BinderAssemblyName = "Infragistics.Shared.v5.1";
}
